  ...
  useEffect(() => {
    ...
    function loop(time: number) {
      ...
      nodes.forEach((n, i) => {
        ...
        // Slightly tighter horizontal spacing since they are physically closer now
        const x = -diff * 6; 
        
        // Brought much closer to the camera (from -10 to -4)
        const worldZ = 2; 
        
        const rotY = clamp(diff * -15, -30, 30); 
        ...
        const scale = clamp(8 / (camera.position.z - worldZ), 0.05, 3.0);
