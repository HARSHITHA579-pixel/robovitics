  ...
  return (
    <main className="relative bg-black text-white flex flex-col font-sans selection:bg-gray-300 selection:text-black">
      ...
      <motion.div
        ...
        className="fixed -left-28 -bottom-28 z-10 opacity-[0.16] pointer-events-none sm:-left-32 sm:-bottom-32 sm:opacity-[0.16] lg:-left-40 lg:-bottom-40 lg:opacity-20"
      >
        <svg className="h-[390px] w-[390px] sm:h-[460px] sm:w-[460px] lg:h-[600px] lg:w-[600px]" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="0.5" strokeLinecap="round" strokeLinejoin="round">
